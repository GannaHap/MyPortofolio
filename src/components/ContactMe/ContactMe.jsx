...
export default class ContactMe extends Component {
  sendMessage = (event) => {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbzg5w_6azxfs3mwjpi9B9l7uMb4y0d5NJy-cztEg3Fwy1PeGPjKhsjOlio12WNZ9SFf/exec';
  ...
  render() {
    return (
      <div className="contact-me">
        ...
        <form name="form-contact-me" className="form-contact-me" onSubmit={(e) => this.sendMessage(e)}>
          ...
          <input type="text" name="subject" id="subject" className="input" />

          <label htmlFor="pesan">Pesan</label>
          <textarea id="pesan" name="message" cols="30" rows="10" className="input"></textarea>
